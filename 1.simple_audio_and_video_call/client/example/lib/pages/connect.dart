...
import 'package:livekit_example/pages/personal_page.dart';
...
class _ConnectPageState extends State<ConnectPage> {
  ...
  Future<void> _readPrefs() async {
    ...
    _email_input_controller.text = const bool.hasEnvironment('EMAIL')
        ? const String.fromEnvironment('EMAIL')
        : prefs.getString(_store_email_key) ?? '';
    setState(() {
  ...
  Future<void> _writePrefs() async {
    ...
    await prefs.setString(_store_email_key, _email_input_controller.text);
